...
cardSystem.addEventListener('change', () => {
  ...
  switch (option) {
    case 'МИР':
      ...
      break;
    case 'MasterCard':
      system.src = 'https://logodownload.org/wp-content/uploads/2014/07/mastercard-logo-3.png';
      break;
    case 'VISA':
    ...
    case 'American Express':
      ...
      break;
    case 'Maestro':
      system.src = 'https://logodownload.org/wp-content/uploads/2018/05/maestro-logo-3.png';
      break;
  }
});
